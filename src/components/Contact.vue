            ...
            <div class="grid md:grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-4">
                            <a href="#" target="_blank"
                                class="bg-gray-100 p-3 rounded-full text-gray-700 hover:bg-red-100 hover:text-red-600 transition duration-300">
                ...
                <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                    ...
                    <form class="space-y-6" @submit.prevent="sendEmail">
                        ...
                        <div>
                            <button type="submit"
                                class="w-full bg-red-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-red-700 transition duration-300 shadow-md hover:shadow-lg flex items-center justify-center">
